        ...
        <div className='relative min-h-screen'>
            ...
            <div className='relative z-50 '>
                <nav className='md:flex md:justify-between md:items-center md:px-40 py-5 backdrop:blur-2xl flex justify-between items-center text-xl px-10'>
                    <h1 className='md:text-3xl text-2xl font-mono font-extrabold text-white/70'>GlobeTrekker</h1>

                    <button className='md:text-xl text-sm border-2 p-2 rounded-4xl hover:bg-amber-200 font-mono transition-all duration-500 cursor-pointer' onClick={() => signIn()}>Log In</button>
                </nav>
